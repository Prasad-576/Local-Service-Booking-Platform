          ...
          >
            {isLoggedIn ? (
              <>
                ...
                <div className="p-2 flex flex-col gap-1">
                  <button className="w-full flex items-center gap-3 px-3 py-2 text-sm font-medium text-rose-300 bg-transparent rounded-lg hover:bg-rose-500/10 transition-colors duration-200">
